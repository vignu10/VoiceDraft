    ...
    <div className="relative" ref={dropdownRef}>
      ...
      <div className="relative">
        <input
          ...
          className={cn(
            'w-full px-3 py-2 pr-10 border border-neutral-300 dark:border-neutral-700 rounded-lg',
        ...
        {/* Tag icon */}
        <TagIcon className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-neutral-400 pointer-events-none" />
      </div>

      {/* Dropdown */}
      {showDropdown && (filteredTags.length > 0 || inputValue) && (
        <div className="absolute z-10 w-full mt-1 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-lg shadow-lg overflow-hidden">
