...
export function BlogHeader({ journal }: BlogHeaderProps) {
  ...
  return (
    <header className="border-b border-neutral-200 bg-white py-8 dark:border-neutral-800 dark:bg-neutral-900">
      <div className="container-wide">
        <div className="flex flex-col items-center gap-4 text-center sm:flex-row sm:items-start sm:text-left">
          ...
          >
            <div className="relative h-16 w-16 overflow-hidden rounded-full bg-neutral-100 dark:bg-neutral-800 sm:h-20 sm:w-20">
              {user_profiles.avatar_url ? (
                ...
                <div className="flex h-full w-full items-center justify-center text-2xl font-semibold text-neutral-600 dark:text-neutral-400">
          ...
          <div className="flex-1">
            ...
            {user_profiles.bio && (
              <p className="mt-2 text-xs text-neutral-500 dark:text-neutral-500 sm:text-sm">
