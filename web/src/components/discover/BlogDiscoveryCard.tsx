...
export function BlogDiscoveryCard({ blog }: BlogDiscoveryCardProps) {
  ...
  return (
    <Link
      href={`/${url_prefix}`}
      className="group relative flex flex-col overflow-hidden rounded-2xl border-2 border-neutral-200/50 bg-frosted transition-all duration-300 hover:-translate-y-1 hover:border-neutral-400/50 hover:shadow-2xl hover:shadow-neutral-500/10 dark:border-neutral-800/50 dark:hover:border-neutral-600/50"
    >
